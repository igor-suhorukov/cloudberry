...
// under the License.
//
//	Ported from github/cloudberry/src/include/gpopt/translate/CTranslatorDXLToPlStmt.h,
...
private:
	...
	// put a Result's filter where PostgreSQL 19 evaluates one; see the
	// definition
	Plan *PlaceResultFilter(Result *result);
