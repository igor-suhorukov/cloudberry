...
// under the License.
//
//	Ported from github/cloudberry/src/backend/gpopt/translate/CQueryMutators.cpp,
									  ...
									  BOOL should_fix_having_qual)
{
	...
	// Cloudberry moves the query's intoPolicy and parentStmtType up here, to
	// the query the derived table goes into, since they belong to the top
	// query.  PostgreSQL 19's Query has neither; see
