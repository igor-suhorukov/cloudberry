...
// under the License.
//
//	Ported from github/cloudberry/src/backend/gpopt/translate/CContextDXLToPlStmt.cpp,
...
//---------------------------------------------------------------------------
//	@function:
//		CContextDXLToPlStmt::AddRewindPlanId
//
//	@doc:
//		Mark a subplan as one to be rescanned from the start
//
//---------------------------------------------------------------------------
void
CContextDXLToPlStmt::AddRewindPlanId(int plan_id)
{
	m_rewind_plan_ids = gpdb::BmsAddMember(m_rewind_plan_ids, plan_id);
}
